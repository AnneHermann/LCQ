 ...
 * </p>
 * <ul>
 *   <li>{@link AlleKnotenFormartiert.impl.ItemTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemTypeImpl extends MinimalEObjectImpl.Container implements ItemType {
	...
	protected EClass eStaticClass() {
		return AlleKnotenFormartiertPackage.Literals.ITEM_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlleKnotenFormartiertPackage.ITEM_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlleKnotenFormartiertPackage.ITEM_TYPE__VALUE:
				return getValue();
		}
