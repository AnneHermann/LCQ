 ...
 * </p>
 * <ul>
 *   <li>{@link BspKnotensystem.impl.InputsTypeImpl#getInput <em>Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputsTypeImpl extends MinimalEObjectImpl.Container implements InputsType {
	...
	protected EClass eStaticClass() {
		return BspKnotensystemPackage.Literals.INPUTS_TYPE;
	}
	...
	public EList<InputType> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList<InputType>(InputType.class, this, BspKnotensystemPackage.INPUTS_TYPE__INPUT);
		}
		return input;
	}
