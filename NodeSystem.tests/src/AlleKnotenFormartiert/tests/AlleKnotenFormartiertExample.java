...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>AlleKnotenFormartiert</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AlleKnotenFormartiertExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.alleknotenformartiert"));
				DocumentRoot documentRoot = AlleKnotenFormartiertFactory.eINSTANCE.createDocumentRoot();
				FunctionResultType root = AlleKnotenFormartiertFactory.eINSTANCE.createFunctionResultType();
				documentRoot.setFunctionResult(root);
