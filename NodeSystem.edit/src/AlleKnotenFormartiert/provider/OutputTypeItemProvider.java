...
/**
 * This is the item provider adapter for a {@link AlleKnotenFormartiert.OutputType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputType_nodeId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputType_nodeId_feature", "_UI_OutputType_type"),
				 AlleKnotenFormartiertPackage.Literals.OUTPUT_TYPE__NODE_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((OutputType)object).getNodeId();
